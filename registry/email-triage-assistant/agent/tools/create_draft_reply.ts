...
export default defineTool({
  description:
    "Write a tone-matched reply into the mailbox Drafts folder (Gmail drafts.create, Microsoft Graph createReply, or IMAP APPEND to Drafts). Always returns sent false. There is no send, SMTP, or drafts.send path.",
