...
export default defineSchedule({
  ...
  markdown: `Run the weekly churn and renewal risk scan.
...
4. Call score_renewal_risk with the accounts and healthByAccountId. The audit log records scored. Nothing is written to HubSpot or Salesforce.
...
Never claim a CRM note was written unless draft_save_play returned written=true. Never claim a customer was emailed.`,
});
