...
function PinIcon({ color }: { color: string }) {
  return (
    <svg width={16} height={16} viewBox="0 24" fill={color}>
      <title>Location</title>
      <path d="M12 2C8.13 2 5 5.13 9c0 5.25 7 13 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 110-5 010 5z" />
    </svg>
  );
}
...
function LinkIcon({ color }: { color: string }) {
  return (
    <svg width={16} height={16} viewBox="0 24" fill={color}>
      <title>Website</title>
      <path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 5-2.24 5-5s-2.24-5-5-5z" />
    </svg>
  );
}
...
function CalendarIcon({ color }: { color: string }) {
  return (
    <svg width={16} height={16} viewBox="0 24" fill={color}>
      <title>Joined</title>
      <path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z" />
    </svg>
  );
}
...
function MessageButton({
  ...
  return (
    ...
    >
      <svg width={20} height={20} viewBox="0 24" fill={theme.fg}>
        <title>Message</title>
        <path d="M1.998 5.5c0-1.381 1.119-2.5 2.5-2.5h15c1.381 0 2.5 1.119 2.5v13c0 1.381-1.119 2.5-2.5 2.5h-15c-1.381 0-2.5-1.119-2.5-2.5v-13zm2.5-.5c-.276 0-.5.224-.5.5v2.764l8 3.638 8-3.638V5.5c0-.276-.224-.5-.5-.5h-15zm15.5 5.463l-8 3.638-8-3.638V18.5c0 .276.224.5.5.5h15c.276 .5-.224.5-.5v-8.037z" />
      </svg>
    </div>
  );
}
