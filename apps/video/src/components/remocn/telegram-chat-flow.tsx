...
function PaperPlane({ color }: { color: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M14.536 21.686a.5.5 0 .937-.024l6.5-19a.496.496 0-.635-.635l-19 6.5a.5.5 0-.024.937l7.93 3.18a2 2 1 1.112 1.11z" />
...
function AttachIcon({ color }: { color: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="m16 6-8.414 8.586a2 2 0 2.829 2.829l8.414-8.586a4 4 1 0-5.657-5.657l-8.379 8.551a6 6 8.485 8.485l8.379-8.551" />
    </svg>
  );
}
...
function PhoneIcon({ color }: { color: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M13.832 16.568a1 1 0 1.213-.303l.355-.465A2 2 17 15h3a2 2v3a2 1-2 2A18 18 4a2 2-2h3a2 1-.8 1.6l-.468.351a1 0-.292 1.233 14 6.392 6.384" />
    </svg>
  );
}
...
function BubbleTail({ side, color }: { side: "left" | "right"; color: string }) {
  const path =
    side === "right"
      ? "M0 0 H4 C4 7 12 13 C6 9 Z"
      : "M13 0 H9 C9 7 6 12 13 C7 9 Z";
  return (
    <svg
      width={13}
      height={13}
  ...
  const bubble = (
    <div
      style={{
        ...
        boxShadow: outgoing ? "none" : "0 1px rgba(0,0,0,0.1)",
        fontSize: 15,
        lineHeight: 1.35,
      }}
    >
