...
const ARROW_PATH =
  "M1 1 L1 18.5 L5.6 14.4 L8.7 21.6 L11.6 20.4 L8.5 13.2 L14.5 Z";
const POINTER_PATH =
  "M8 2.2 C8 1.3 8.7 0.7 9.5 C10.3 11 L11 9" +
  "C11 9 11.3 8.4 12.2 C13 13.4 9.6" +
  "C13.4 9.6 13.9 9.1 14.7 C15.5 15.9 9.7 10.3" +
  "C15.9 10.3 16.4 9.9 17.1 C17.9 18.3 10.5 11.2" +
  "L18.3 16.8 C18.3 19.8 16.3 22.3 12.8 L11.4" +
