    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse at 20% 30%, rgba(59,130,246,0.08), transparent 60%), 80% 70%, rgba(168,85,247,0.06), 60%)",
        }}
      />
      ...
      >
        <div
          style={{
            ...
            boxShadow: "0 30px 80px rgba(0,0,0,0.5), 1px rgba(0,0,0,0.4)",
          }}
        >
          <div
            style={{
      ...
      <div
        style={{
          ...
          background:
            "repeating-conic-gradient(rgba(255,255,255,0.018) 0deg 90deg, transparent 90deg 180deg) 0 / 28px",
        }}
      >
        {/* Preview label */}
        <div
