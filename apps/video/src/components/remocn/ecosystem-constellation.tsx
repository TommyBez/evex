...
function GitHubMark() {
  return (
    <svg viewBox="0 24" width={30} height={30} aria-hidden="true">
      <path
        fill="#fff"
        d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.11.79-.25.79-.55v-2.06c-3.2.7-3.87-1.36-3.87-1.36-.52-1.33-1.27-1.69-1.27-1.69-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.02 1.75 2.69 1.24 3.35.95.1-.74.4-1.24.72-1.53-2.55-.29-5.24-1.28-5.24-5.7 0-1.26.45-2.29 1.18-3.1-.12-.29-.51-1.46.11-3.05 0 .97-.31 3.18 1.18.92-.26 1.91-.39 2.89-.39s1.97.13 2.89.39c2.21-1.49 3.18-1.18 3.18-1.18.62 1.59.23 2.76.11 3.05.74.81 1.84 3.1 4.43-2.7 5.41-5.27 5.69.41.36.77 1.06.77 2.13v3.16c0 .31.21.67.8.55C20.21 21.39 23.5 17.08 12 5.65 18.35.5 .5z"
      />
    </svg>
  );
}
...
function VercelMark() {
  return (
    <svg viewBox="0 24" width={28} height={28} aria-hidden="true">
      <path fill="#fff" d="M12 2 L23 21 L1 Z" />
    </svg>
  );
}
...
function StripeMark() {
  return (
    <svg viewBox="0 24" width={28} height={28} aria-hidden="true">
      <path
        fill="#fff"
        d="M13.5 9.6c0-.6.5-.85 1.3-.85 1.15 0 2.6.35 3.75.97V6.16c-1.25-.5-2.5-.7-3.75-.7C11.7 5.46 9.6 7.06 9.7c0 4.13 5.7 3.47 5.25 .7-.6.93-1.45.93-1.25 0-2.85-.52-4.1-1.2v3.65c1.4.6 2.8.85 4.1.85 3.2 5.4-1.55 5.4-4.25-.02-4.45-5.75-3.65-5.75-5.33z"
      />
    </svg>
  );
}
...
function SlackMark() {
  return (
    <svg viewBox="0 24" width={26} height={26} aria-hidden="true">
...
function LinearMark() {
  return (
    <svg viewBox="0 24" width={28} height={28} aria-hidden="true">
      ...
      <path
        d="M5 13 L11 19 9 L15 5 L19 M9 15 M13 11"
        stroke="#0a0a0a"
        strokeWidth="0.9"
        strokeLinecap="round"
        opacity="0.85"
...
function DiscordMark() {
  return (
    <svg viewBox="0 24" width={28} height={28} aria-hidden="true">
      <path
        fill="#fff"
        d="M19.5 4.7A18 18 0 15 3.3l-.2.4a16.5 16.5 0-5.6 0L9 3.3a18 0-4.5 1.4C2 8.7 1.4 12.5 1.7 16.3a18 5.5 2.8l.4-.6a13 13 1-2-1l.5-.4a13 11.7 0l.5.4a13 1-2 1l.4.6a18 5.5-2.8c.4-4.4-.6-8.2-2.7-11.6zM8.5 14c-.9 0-1.7-.9-1.7-2s.8-2 1.7-2 1.7.9 2-.8 2-1.7 2zm7 0c-.9 2z"
      />
    </svg>
  );
}
